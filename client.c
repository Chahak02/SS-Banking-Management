...
/**
 * Main function - Implements the client side of the banking system
 * Handles connection to server and user interactions for all roles:
 * - Customer (Account operations, transactions)
 * - Employee (Customer management, loan approvals)
 * - Manager (Account management, loan assignments)
 * - Admin (System management)
 */
int main()
{
    // Server connection setup
    char *server_address = "127.0.0.1"; // Loopback address for local server
    ...
    while (1)
    {
        ...
        // Common variables for authentication
        int menu_choice;
        char username[1024];
        char password[1024];
        int userid;
        ...
        case 1: // Customer Operations
        {
            ...
            if (strcmp("Authentication Successful", auth_buffer) == 0 || strcmp("admin authenticated", auth_buffer) == 0 || strcmp("authenticated", auth_buffer) == 0)
            {
                ...
                while (1)
                {
                    ...
                    {
                        perror("send user_choice failed");
                        break;
                    }
                    ...
                    case 2: // Deposit
                    {
                        ...
                        if (rec_deposit <= 0)
                        {
                            perror("recv deposit confirm failed");
                            break;
                        }
                    ...
                    case 3: // Withdraw
                    {
                        ...
                        if (rec_withdraw <= 0)
                        {
                            perror("recv withdraw confirm failed");
                            break;
                        }
        ...
        case 2: // Employee Operations
        {
            ...
            if (strcmp(auth_buffer, "Authentication Successful") == 0)
            {
                ...
                while (1)
                {
                    ...
                    {
                        perror("send employee menu failed");
                        break;
                    }
                    ...
                    case 1: // Add new customer
                    {
                        ...
                        {
                            perror("send new customer id failed");
                            break;
                        }
                        ...
                        {
                            perror("send new customer password failed");
                            break;
                        }
                        ...
                        {
                            perror("recv add customer resp failed");
                            break;
                        }
                        if (a == 0)
                    ...
                    case 2: // Modify customer details
                    {
                        ...
                        {
                            perror("send modify choice failed");
                            break;
                        }
                        switch (choice)
                        {
                        ...
                        case 2:
                        {
                            ...
                            {
                                perror("send new contact failed");
                                break;
                            }
                            break;
                        }
                        case 3:
                        {
                            ...
                            {
                                perror("send new address failed");
                                break;
                            }
                            break;
                        }
                        ...
                        if (rec <= 0)
                        {
                            perror("recv modify resp failed");
                            break;
                        }
                        s[rec] = '\0';
                    ...
                    case 3: // Approve loan
                    {
                        ...
                        {
                            perror("send approve loan id failed");
                            break;
                        }
                        char buffer2[1024];
                        ...
                        if (rec <= 0)
                        {
                            perror("recv approve loan resp failed");
                            break;
                        }
                        buffer2[rec] = '\0';
                        printf("%s", buffer2);
                    ...
                    case 6: // Change Password
                    {
                        ...
                        {
                            perror("send emp new pwd failed");
                            break;
                        }
                        char s_[200];
                        ...
                        if (rcv <= 0)
                        {
                            perror("recv emp change pwd ack failed");
                            break;
                        }
                        s_[rcv] = '\0';
                        printf("%s", s_);
        ...
        case 3: // Manager Operations
        {
            ...
            if (send(clientSocket, username, strlen(username) + 1, 0) <= 0)
            {
                perror("send mgr username failed");
                break;
            }
            printf("Enter password: \n");
            if (scanf("%1023s", password) != 1)
            ...
            if (send(clientSocket, password, strlen(password) + 1, 0) <= 0)
            {
                perror("send mgr password failed");
                break;
            }
            printf("Enter user_id: \n");
            if (scanf("%d", &userid) != 1)
            ...
            if (strcmp(auth_buffer, "Authentication Successful") == 0)
            {
                ...
                while (1)
                {
                    ...
                    case 1: // Deactivate account
                    {
                        ...
                        {
                            perror("send deactivate id failed");
                            break;
                        }
                        break;
                    }
                    ...
                    case 3: // Assign loan application to employee
                    {
                        ...
                        {
                            perror("send assign cust failed");
                            break;
                        }
                        char loan_buff[256];
                        memset(loan_buff, 0, sizeof(loan_buff));
                        ...
                        if (rec_loan <= 0)
                        {
                            perror("recv assign loan resp failed");
                            break;
                        }
                        loan_buff[rec_loan] = '\0';
                        printf("%s", loan_buff);
                    ...
                    case 4: // Review Feedback
                    {
                        ...
                        if (recv_feedback > 0)
                        {
                            ...
                            // Only ask for response if real feedback is shown
                            if (strstr(feedback_msg, "No unresolved") == NULL)
                            {
                                printf("If feedback is resolved, press 'Y' else 'N': ");
                                char resp;
                                scanf(" %c", &resp);
                        ...
                        {
                            printf("No feedback found or connection issue.\n");
                        }
                        break;
                    }
                    case 5: // Change password
                    {
                        ...
                        {
                            perror("send mgr new pwd failed");
                            break;
                        }
                        char pass_buff[1024];
                        ...
                        if (rec_new_pass <= 0)
                        {
                            perror("recv mgr new pwd ack failed");
                            break;
                        }
                    ...
                    default:
                    {
                        ...
                        if (rec_def <= 0)
                        {
                            perror("recv default resp failed");
                            break;
                        }
        ...
        case 4: // Admin Operations
        {
            ...
            {
                perror("send admin username failed");
                break;
            }
            ...
            if (strcmp("admin authenticated", auth_buff) == 0 || strcmp("Authentication Successful", auth_buff) == 0)
            {
                ...
                while (1)
                {
                    ...
                    if (send(clientSocket, &choice, sizeof(choice), 0) <= 0)
                    {
                        perror("send admin choice failed");
                        break;
                    }
                    ...
                    case 1: // Add New Bank Employee
                    {
                        ...
                        {
                            perror("send new emp name failed");
                            break;
                        }
                        ...
                        {
                            perror("send new emp pass failed");
                            break;
                        }
                        ...
                        if (rcv <= 0)
                        {
                            perror("recv add emp resp failed");
                            break;
                        }
                        buff_resp[rcv] = '\0';
                    ...
                    case 2: // Modify Customer
                    {
                        ...
                        {
                            perror("send admin modify cust id failed");
                            break;
                        }
                        ...
                        {
                            perror("send admin modify key failed");
                            break;
                        }
                        switch (ch_key)
                        {
                        case 1:
                        {
                            ...
                            {
                                perror("send admin new name failed");
                                break;
                            }
                            break;
                        }
                        case 2:
                        {
                            ...
                            {
                                perror("send admin new contact failed");
                                break;
                            }
                            break;
                        }
                        case 3:
                        {
                            ...
                            if (send(clientSocket, address_new, strlen(address_new) + 1, 0) <= 0)
                            {
                                perror("send admin new address failed");
                                break;
                            }
                            break;
                        }
                        ...
                        if (rcv2 <= 0)
                        {
                            perror("recv admin modify resp failed");
                            break;
                        }
                        s[rcv2] = '\0';
                        if (strcmp(s, "record updated.") == 0)
                    ...
                    case 3: // Modify Employee
                    {
                        ...
                        {
                            perror("send admin modify emp id failed");
                            break;
                        }
                        ...
                        {
                            perror("send admin new emp name failed");
                            break;
                        }
                        char buu_em[200];
                        ...
                        if (recm <= 0)
                        {
                            perror("recv admin modify emp resp failed");
                            break;
                        }
                        buu_em[recm] = '\0';
                        if (recm <= 0)
                    ...
                    case 4: // Manage User Roles
                    {
                        ...
                        {
                            perror("send admin role id failed");
                            break;
                        }
                        char s2[200];
                        ...
                        if (rcv5 <= 0)
                        {
                            perror("recv admin role resp failed");
                            break;
                        }
                        s2[rcv5] = '\0';
                        printf("%s", s2);
                    ...
                    case 5: // Change password
                    {
                        ...
                        {
                            perror("send admin new pwd failed");
                            break;
                        }
                        char s3[200];
                        ...
                        if (rcv6 <= 0)
                        {
                            perror("recv admin change pwd ack failed");
                            break;
                        }
                        s3[rcv6] = '\0';
                        printf("%s", s3);
                    ...
                    case 6: // Logout
                    {
                        ...
                        if (rcv7 <= 0)
                        {
                            perror("recv admin logout failed");
                            break;
                        }
                        s4[rcv7] = '\0';
                        printf("%s", s4);
