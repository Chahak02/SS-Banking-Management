 ...
 *
 * Updates customer balance by adding the deposit amount.
 * Uses file locking to ensure thread-safe balance updates.
 * Logs the transaction in transaction history.
 *
 * @param client_socket Socket descriptor for client communication
 * @param customer_id ID of customer making the deposit
 * @param add_balance Amount to be deposited
 */
 ...
 *
 * Updates customer balance by subtracting the withdrawal amount.
 * Checks for sufficient balance before processing.
 * Uses file locking to ensure thread-safe balance updates.
 * Logs the transaction in transaction history.
 *
 * @param client_socket Socket descriptor for client communication
 * @param customer_id ID of customer making the withdrawal
...
/**
 * @brief Processes a fund transfer between two customers
 *
 * Transfers funds between two customer accounts:
 * - Verifies both accounts exist
 * - Checks for sufficient balance
 * - Uses dual file locking for thread-safe updates
 * - Updates both balances atomically
 * - Logs transactions for both accounts
 *
 * @param client_socket Socket descriptor for client communication
 * @param sender_customer_id ID of customer sending funds
 * @param receiver_customer_id ID of customer receiving funds
 * @param transfer_amount Amount to be transferred
 */
