...
/**
 * @brief Assigns a loan application to an employee for processing
 *
 * Manager function that assigns pending loan applications to bank employees.
 * Updates the loan database with the employee assignment.
 *
...
/**
 * @brief Processes loan approval by an employee
 *
 * Updates both customer and loan databases with approval status.
 * Requires synchronization between customer and loan records.
 *
 * @param client_socket Socket descriptor for client communication
 * @param employee_id ID of employee processing the loan
 * @param customer_id ID of customer whose loan is being processed
 */
...
/**
 * @brief Handles customer loan application
 *
 * Creates new loan record and updates customer information.
 * Maintains consistency between loan and customer databases.
 *
 * @param client_socket Socket descriptor for client communication
 * @param cust_id ID of customer applying for loan
...
/**
 * @brief Shows loan applications assigned to an employee
 *
 * Lists all loan applications that have been assigned to a specific employee
 *
 * @param employee_id ID of employee whose assignments are to be viewed
 */
...
/**
 * @brief Shows all pending loan applications
 *
 * Lists all loan applications that are in 'applied' status and need to be assigned
 * Used by managers to view applications that need processing
 */
