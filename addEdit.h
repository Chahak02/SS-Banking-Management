 ...
 * Receives customer details from client socket and stores in database
 * Handles:
 * - Customer information validation
 * - Password hashing
 * - Database record creation with file locking
 * - Duplicate customer/account check
 *
 ...
 * Handles employee registration with:
 ...
 * Currently supports updating employee username
 * Uses file locking for safe concurrent access
 *
 * @param client_socket Socket descriptor for client communication
 */
 ...
 * Sets is_active flag to false without deleting the record
 * Uses file locking for safe concurrent access
 *
 * @param customer_id ID of the customer to deactivate
 */
...
/**
 * Promotes an employee to manager role
 * Process:
 * 1. Deactivates employee record
 * 2. Creates new manager record with employee's data
 * Uses file locking for safe concurrent access
 *
 * @param client_socket Socket descriptor for client communication
 * @param employee_id ID of the employee to promote
 */
